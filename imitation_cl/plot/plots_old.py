...
color_models_lsddm = {'FT': '#f58231', 'SI': '#911eb4', 'MAS': '#BC8F8F',
                      'HN': '#e6194B', 'SG': '#1E90FF', 'iFlow': '#800000',
                      'CHN': '#3cb44b', 'REP': 'gray'} # Old dark green: 'CHN': '#224d27'

# New colors
color_models_lsddm = {'FT': '#f79b45', 'SI': '#b41ea5', 'MAS': '#bca68f',
                      'HN': '#fc5bb9', 'SG': '#47a5ed', 'iFlow': '#800000',
                      'CHN': '#49e398', 'REP': '#ababa9'} # Old dark green: 'CHN': '#224d27'

ls_models_node = 'solid'
ls_models_lsddm = 'solid'

marker_models_node = 'o'
marker_models_lsddm = 'D'
...
def plot_cumulative_errors(database_df, 
                           ax, 
                           dataset, 
                           explicit_time, 
                           cl_type, 
    ...
    plot_kwargs = dict(color=color,
                       marker=marker_models_node if traj_type == 'NODE' else marker_models_lsddm,
                       markersize=markersize,
                       markeredgecolor=adjust_lightness(color, 0.5),
                       markeredgewidth=0.5,
                       lw=lw_models[cl_type],
                       ls=ls_models_node if traj_type == 'NODE' else ls_models_lsddm)
