...
def train_all(args):
    ...
    # one for each task
    node = SINODETaskEmbedding(tnet, args.task_emb_dim, args.si_c, args.si_epsilon, explicit_time=args.explicit_time, verbose=True).to(device)
